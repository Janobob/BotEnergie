...
function selectRightAnswer(){
    ...
    else if($(document.getElementById("...das unter freiem Himmel stattfindet.")).length == 1){
        $(document.getElementById("...das unter freiem Himmel stattfindet.")).prop("checked", true).trigger("click");
    }
